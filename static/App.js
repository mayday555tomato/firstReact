            ...
            fetch('/api/issues', {
                ...
                if (response.ok) {
                    response.json().then(function (updatedIssue) {
                        ...
                        var newIssues = _this5.state.issues.concat(updatedIssue); //javascript: array.concat: combine two arrays together, doesnt modify original array, returns a new combined array.
