        ...
        return (
            <div>
                <form>
                    ...
                    <br />
                    Effort: <NumInput name='effort' value={this.state.issue.effort} onChange={this.onChange} />
                    <br />
                    ...
                    <br />
                    Title: <input name='title' value={issue.title} value={issue.title} onChange={this.onChange} />
                    <br />
                    <br />
                    {validationMessage}
