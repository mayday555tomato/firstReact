...
/******/ 	var hotCurrentHash = "b6d9d978d6c033283a0a"; // eslint-disable-line no-unused-vars
...
var _issue = __webpack_require__(8);
...
app.post('/api/issues', function (req, res) {
    ...
    var newIssue = req.body; // from List createIssue fetch 'body: JSON.stringify(newIssue)'
...
app.put('/api/issues/:id', function (req, res) {
    ...
    var error = _issue2.default.validateIssue(issue);
    if (error) {
...
var HelloWorld = function (_React$Component) {
    ...
    _createClass(HelloWorld, [{
        ...
        value: function render() {
            return _react2.default.createElement('h1', null, 'Hello ', this.state.addressee, '!');
        }
    }]);
	...
	var checkForUpdate = function checkForUpdate(fromUpdate) {
		if (module.hot.status() === "idle") {
			module.hot.check(true).then(function (updatedModules) {
				...
				__webpack_require__(16)(updatedModules, updatedModules);
				checkForUpdate(true);
			}).catch(function (err) {
